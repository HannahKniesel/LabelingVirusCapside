...
# TODO write notebook to generate data for study + to prepare labeling data
...
class MainWindow(QtWidgets.QMainWindow, Ui_BinaryLabeling):
    def __init__(self, paths, save_to, start_idx, training_period, *args, obj=None, **kwargs):
        ...
        self.training_imgs = ["../Probanden_TestData/Loc1.png", "../Probanden_TestData/Loc2.png", "../Probanden_TestData/Loc3.png", "../Probanden_TestData/End1.png"]
    ...
    def closeEvent(self, e):
        if((self.curr_idx < len(self.paths)) and (len(self.img.points)>0)):
...
save_to = data['save_to']+"/"+Path(path).stem+"/Location/"
